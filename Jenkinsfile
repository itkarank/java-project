pipeline {
    ...
    stages {
        ...
        stage('Sonarqube Analysis') {               // static code analysis using SonarQube     
            steps {
                sh ''' $SCANNER_HOME/bin/sonar-scanner -Dsonar.url=http://http://44.213.124.96:9000/ -Dsonar.login=squ_db9c6e6e25e00cc0810fe881070ad881b4389194 -Dsonar.projectName=java-project1 \
